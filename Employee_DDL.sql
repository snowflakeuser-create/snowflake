CREATE TABLE "SNOW_PRACTS"."PRACTICE_SCH"."Employee" ( EmployeeID NUMBER(38, 0) , FirstName VARCHAR , LastName VARCHAR , Email VARCHAR , PhoneNumber NUMBER(38, 0) , Department VARCHAR , Designation VARCHAR , JoinDate DATE , Salary NUMBER(38, 0) , Location VARCHAR ); 
...
COPY INTO "SNOW_PRACTS"."PRACTICE_SCH"."Employee" 
